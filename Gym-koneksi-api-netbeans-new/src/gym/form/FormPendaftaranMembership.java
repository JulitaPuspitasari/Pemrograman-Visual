...
public class FormPendaftaranMembership extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnCariPendaftaran = new javax.swing.JButton();
        ...
        btnCariPendaftaran.setBackground(new java.awt.Color(52, 152, 219));
        btnCariPendaftaran.setFont(new java.awt.Font("Segoe UI", 1, 11));
        btnCariPendaftaran.setForeground(new java.awt.Color(255, 255, 255));
        btnCariPendaftaran.setText("Cari");
        btnCariPendaftaran.setBorderPainted(false);
        btnCariPendaftaran.setFocusPainted(false);
        btnCariPendaftaran.setToolTipText("Cari ID Pendaftaran");
        btnCariPendaftaran.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) { btnCariPendaftaranActionPerformed(evt); }
        });
        panelInput.add(btnCariPendaftaran);
        btnCariPendaftaran.setBounds(340, 22, 70, 30);

        btnCariMember.setBackground(new java.awt.Color(52, 152, 219));
        ...
        btnCariPaket.setBackground(new java.awt.Color(52, 152, 219));
    ...
    private void btnCariPendaftaranActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariPendaftaranActionPerformed
        cariPendaftaran();
    }//GEN-LAST:event_btnCariPendaftaranActionPerformed
    ...
    private void cariPendaftaran() {
        ...
        String id = DialogCariId.pilihId(owner, "Pendaftaran", "/pendaftaran", "id_pendaftaran",
            new String[]{"ID Pendaftaran", "ID Member", "ID Paket", "Tgl Daftar", "Tgl Expired", "Status"},
            new String[]{"id_pendaftaran", "id_member", "id_paket", "tanggal_daftar", "tanggal_expired", "status"});
        if (id != null && !id.isEmpty()) {
            txtIdPendaftaran.setText(id);
            ambilIdDariPendaftaran(id);
        }
    }
    ...
    private void setupTabel() {
        ...
        gym.komponen.SwingUtil.makeOpaque(btnSimpan, btnEdit, btnHapus, btnReset,
            btnCariPendaftaran, btnCariMember, btnCariPaket);
    ...
    private javax.swing.JButton btnCariPendaftaran;
