...
public class FormBilling extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnCariBilling = new javax.swing.JButton();
        ...
        lblOpsional.setBounds(420, 130, 80, 25);

        btnCariBilling.setBackground(new java.awt.Color(155, 89, 182));
        btnCariBilling.setFont(new java.awt.Font("Segoe UI", 1, 11));
        btnCariBilling.setForeground(new java.awt.Color(255, 255, 255));
        btnCariBilling.setText("Cari");
        btnCariBilling.setBorderPainted(false);
        btnCariBilling.setFocusPainted(false);
        btnCariBilling.setToolTipText("Cari ID Billing");
        btnCariBilling.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) { btnCariBillingActionPerformed(evt); }
        });
        panelInput.add(btnCariBilling);
        btnCariBilling.setBounds(340, 22, 70, 30);

        btnCariMember.setBackground(new java.awt.Color(155, 89, 182));
        ...
        btnCariMember.setBounds(340, 57, 70, 30);

        btnCariPaket.setBackground(new java.awt.Color(155, 89, 182));
        btnCariPaket.setFont(new java.awt.Font("Segoe UI", 1, 11));
        btnCariPaket.setForeground(new java.awt.Color(255, 255, 255));
        btnCariPaket.setText("Cari");
        btnCariPaket.setBorderPainted(false);
        btnCariPaket.setFocusPainted(false);
        btnCariPaket.setToolTipText("Cari ID Paket");
        btnCariPaket.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) { btnCariPaketActionPerformed(evt); }
        });
        panelInput.add(btnCariPaket);
        btnCariPaket.setBounds(340, 92, 70, 30);

        btnCariTrainer.setBackground(new java.awt.Color(155, 89, 182));
        ...
        btnCariTrainer.setBounds(340, 127, 70, 30);
    ...
    private void btnCariBillingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariBillingActionPerformed
        cariBilling();
    }//GEN-LAST:event_btnCariBillingActionPerformed
    ...
    private void cariBilling() {
        Window owner = SwingUtilities.getWindowAncestor(this);
        String id = DialogCariId.pilihId(owner, "Billing", "/billing", "id_billing",
            new String[]{"ID Billing", "ID Member", "ID Paket", "Tgl Bayar", "Jumlah", "Metode", "Status"},
            new String[]{"id_billing", "id_member", "id_paket", "tanggal_bayar", "jumlah_bayar", "metode_bayar", "status_bayar"});
        if (id != null && !id.isEmpty()) {
            txtIdBilling.setText(id);
            ambilIdDariBilling(id);
        }
    }
    ...
    private void cariPaket() {
        Window owner = SwingUtilities.getWindowAncestor(this);
        String id = DialogCariId.pilihId(owner, "Paket Membership", "/paket", "id_paket",
            new String[]{"ID Paket", "Nama Paket", "Durasi (bulan)", "Harga", "Fasilitas"},
            new String[]{"id_paket", "nama_paket", "durasi_bulan", "harga", "fasilitas"});
        if (id != null && !id.isEmpty()) txtIdPaket.setText(id);
    }
    ...
    private void setupTabel() {
        ...
        gym.komponen.SwingUtil.makeOpaque(btnSimpan, btnEdit, btnHapus, btnReset,
            btnCariBilling, btnCariMember, btnCariPaket, btnCariTrainer);
    ...
    private javax.swing.JButton btnCariBilling;
